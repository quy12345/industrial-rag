...
SOURCES = (
    {
        ...
        "title": "Altivar Machine ATV320 Variable Speed Drives for Asynchronous and Synchronous Motors Installation Manual",
    ...
    },
    {
        ...
        "title": "Altivar Machine ATV320 Variable Speed Drives for Asynchronous and Synchronous Motors Programming Manual",
...
def main() -> int:
    ...
    parser.add_argument("--output", type=Path, default=Path("artifacts/metrics/phase-7-corpus-audit.json"))
            ...
            try:
                ...
                documents.append({
                    **source,
                    ...
                    "ocr_required": False,
                    "observed_structure": [
                        "heading hierarchy", "repeated headers/footers", "safety warnings",
                        "tables", "wiring/terminal identifiers", "parameter or fault-code tables",
                    ],
                    "known_parsing_risks": [
